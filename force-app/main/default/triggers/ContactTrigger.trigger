trigger ContactTrigger on Contact (after undelete, before delete,After Insert,before insert,before update) {
/*
...
*/
    ...
    if(trigger.isAfter && trigger.isInsert){
       // Youngastronaut20.forFullName(trigger.new);
    }
    ...
    if(trigger.isBefore){
        ...
        for(contact con : trigger.new){
            ...
            system.debug('con.FullName__c '+con.FullName__c);
            }
        }
    }
}